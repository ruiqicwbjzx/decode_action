//Mon Jan 20 2025 07:29:33 GMT+0000 (Coordinated Universal Time)
...
async function loadUtils() {
  ...
  if (i1l1iiI && i1l1iiI.length) {
    return console.log("✅ " + $.name + ": 缓存中存在Utils代码, 跳过下载"), eval(i1l1iiI), creatUtils();
  }
  return console.log("🚀 " + $.name + ": 开始下载Utils代码"), new Promise(I1I111l => {
